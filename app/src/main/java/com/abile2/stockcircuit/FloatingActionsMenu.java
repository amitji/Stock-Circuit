...
public class FloatingActionsMenu extends ViewGroup {
      ...
      for (int i = mButtonsCount - 1; i >= 0; i--) {
        ...
        if (label != null) {
          ...
          Rect touchArea = new Rect(
              Math.min(childX, labelLeft), childY - mButtonSpacing / 2,
  ...
  //Amit functions
public void hideFragments(RelativeLayout activeFragment) {
	// TODO Auto-generated method stub
	activeFragment.setVisibility(View.GONE);
}

public void setFragmentVisibility(int isvisible){
