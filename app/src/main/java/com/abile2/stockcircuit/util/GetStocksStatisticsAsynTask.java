...
public class GetStocksStatisticsAsynTask extends AsyncTask<Object, Void, String>{
	Context ctx;
	public GetStocksStatisticsAsynTask(Context ctx) {
		this.ctx = ctx;
	}
	...
	protected String doInBackground(Object... params) {
		HttpContext localContext = new BasicHttpContext();
			...
			HttpPost httpPost = new HttpPost(Constants.SERVER_BASE_URL+"stockcircuit/getStocksStatistics");
